...
5. Add relationships when a typed connection is supported by claims or evidence.
6. Add theses and debates as separate interpretive layers.
7. Run `uv run fo lint` before opening a PR.
